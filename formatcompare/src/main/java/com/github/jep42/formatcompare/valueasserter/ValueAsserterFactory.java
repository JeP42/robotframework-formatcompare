...
import com.github.jep42.formatcompare.valueasserter.impl.BooleanAsserterImpl;
...
public final class ValueAsserterFactory {
    ...
    public static ValueAsserter<Boolean> getValueComparatorForBoolean() {
        return new BooleanAsserterImpl();
    }
